...
module Jumpstart
  class Configuration
    ...
    def initialize(options = {})
      ...
      self.marketplace = false if marketplace.nil?
    end
    ...
    def personal_accounts
      ActiveModel::Type::Boolean.new.cast(@personal_accounts || true)
    end

    def marketplace=(value)
      @marketplace = ActiveModel::Type::Boolean.new.cast(value)
    end

    def marketplace
      ActiveModel::Type::Boolean.new.cast(@marketplace || false)
    end
